...
- [Strict TypeScript API by default](/blog/2026/08/11/react-native-0.87#strict-typescript-api-by-default)
- [Faster, leaner Metro](/blog/2026/08/11/react-native-0.87#faster-leaner-metro)
- [Experimental Swift Package Manager support for iOS](/blog/2026/08/11/react-native-0.87#experimental-swift-package-manager-support-for-ios)
...
These are Headers only frameworks and thanks to this change headers now resolve through standard framework and header search path mechanics, and every namespace has exactly one physical home.
